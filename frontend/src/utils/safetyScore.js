/**
 * Calculate Safety Score Utility (Frontend)
 * 
...
/**
 * Get Tailwind CSS color class for safety score
 * @param {number} score - Safety score (0-3)
 * @returns {string} Tailwind color class
 */
export const getSafetyTailwindColor = (score) => {
  const colors = {
    0: 'red',    // Red - Very Unsafe
    1: 'orange', // Orange - Unsafe
    2: 'yellow', // Yellow - Safe
    3: 'green',  // Green - Very Safe
  }
  return colors[score] || colors[0]
}
